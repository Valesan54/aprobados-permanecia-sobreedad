...
Análisis de datos **SIMULADOS** relacionados con la repitencia y sobreedad en las escuelas primarias de PBA.
...
Los datos fueron analizados en Google Colab utilizando diversas librerías de Python.
...
* En el primero se expone la información concentrada en 3 tarjetas puntuales.
